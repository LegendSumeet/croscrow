...
class ProductDetailCopyCopyCopyWidget extends StatefulWidget {
  ...
  @override
  State<ProductDetailCopyCopyCopyWidget> createState() => _ProductDetailCopyCopyCopyWidgetState();
}

class _ProductDetailCopyCopyCopyWidgetState extends State<ProductDetailCopyCopyCopyWidget> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view', parameters: {'screen_name': 'ProductDetailCopyCopyCopy'});
                            ...
                            children: [
                              SingleChildScrollView(
                                child: Column(
                                  ...
                                  children: [
                                    Align(
                                      alignment: const AlignmentDirectional(0.0, -2.49),
                                      child: Container(
                                        height: 700.0,
                                        decoration: BoxDecoration(
                                          color: FlutterFlowTheme.of(context).secondaryBackground,
                                        ...
                                        child: Builder(
                                          builder: (context) {
                                            final images = rowItemsRecord.images.toList();
                                            ...
                                            return SizedBox(
                                              ...
                                              child: CarouselSlider.builder(
                                                ...
                                                options: CarouselOptions(
                                                  ...
                                                  autoPlayInterval: const Duration(milliseconds: (500 + 4000)),
                                    ...
                                    Padding(
                                      ...
                                      child: Container(
                                        ...
                                        child: Padding(
                                          ...
                                          child: Builder(
                                            builder: (context) {
                                              final list = rowItemsRecord.images.toList();
                                  ...
                                  Align(
                                    ...
                                    child: Padding(
                                      ...
                                      child: FlutterFlowIconButton(
                                        ...
                                        onPressed: () async {
                                          logFirebaseEvent('PRODUCT_DETAIL_COPY_COPY_COPY_chevron_le');
                                    ...
                                    child: Builder(
                                      builder: (context) => Padding(
                                        ...
                                        child: FlutterFlowIconButton(
                                          ...
                                          onPressed: () async {
                                            logFirebaseEvent('PRODUCT_DETAIL_COPY_COPY_COPY_share_outl');
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Align(
                        alignment: const AlignmentDirectional(-1.0, 0.0),
                        child: Padding(
                          padding: const EdgeInsetsDirectional.fromSTEB(20.0, 15.0, 15.0, 10.0),
                          child: Container(
                            width: double.infinity,
                            decoration: BoxDecoration(
                              color: FlutterFlowTheme.of(context).secondaryBackground,
                                  ...
                                  children: [
                                    Builder(
                                      builder: (context) => Padding(
                                        ...
                                        child: InkWell(
                                          ...
                                          onTap: () async {
                                            logFirebaseEvent('PRODUCT_DETAIL_COPY_COPY_COPY_Icon_8qzci');
                                              ...
                                              builder: (dialogContext) {
                                                return Material(
                                                  ...
                                                  child: GestureDetector(
                                                    ...
                                                    child: SizecomponentWidget(
                                                      itemref: rowItemsRecord.reference,
                                                    ),
                                                  ),
                                                );
                                              },
                                    ...
                                    Expanded(
                                      child: FlutterFlowChoiceChips(
                                        options: functions
                                                .newCustomFunction2(rowItemsRecord.sizexs, rowItemsRecord.sizes, rowItemsRecord.sizem,
                                                    rowItemsRecord.sizem, rowItemsRecord.sizexl, rowItemsRecord.sizexxl)
                            ...
                            children: [
                              Padding(
                                ...
                                child: InkWell(
                                  ...
                                  highlightColor: Colors.transparent,
                                  onTap: () async {
                                    logFirebaseEvent('PRODUCT_DETAIL_COPY_COPY_COPY_Icon_mmt74');
                                    if (MediaQuery.sizeOf(context).width > 750.0) {
                              ...
                              Padding(
                                ...
                                child: ToggleIcon(
                                  onPressed: () async {
                                    safeSetState(
                                      () => FFAppState().gav.contains(rowItemsRecord.reference)
                                          ? FFAppState().removeFromGav(rowItemsRecord.reference)
                                          : FFAppState().addToGav(rowItemsRecord.reference),
                                    );
                                  },
                                  value: FFAppState().gav.contains(rowItemsRecord.reference),
                                  onIcon: Icon(
                                ...
                                child: Align(
                                  ...
                                  child: Padding(
                                    ...
                                    child: FFButtonWidget(
                                      onPressed: () async {
                                        logFirebaseEvent('PRODUCT_DETAIL_COPY_COPY_COPY_BUTTON_BTN');
                                        if (rowItemsRecord.stock == 0) {
                                          ...
                                          FFAppState().addToCart(CartitemtypeStruct(
                                            ...
                                            menuitemref: rowItemsRecord.reference,
                                            quantity: 1,
                                          ));
                                          FFAppState().cartsum = FFAppState().cartsum + rowItemsRecord.price;
                                          safeSetState(() {});
                                          logFirebaseEvent('Button_show_snack_bar');
                                          ScaffoldMessenger.of(context).showSnackBar(
                                            SnackBar(
                                      ...
                                      text: rowItemsRecord.stock == 0 ? 'out of stock' : 'Add to cart',
                      ...
                      Padding(
                        padding: const EdgeInsetsDirectional.fromSTEB(30.0, 10.0, 24.0, 15.0),
                        child: Container(
                          width: double.infinity,
                          decoration: BoxDecoration(
                            color: FlutterFlowTheme.of(context).secondaryBackground,
                                        ...
                                        child: Padding(
                                          ...
                                          child: StreamBuilder<List<BrandsRecord>>(
                                            stream: queryBrandsRecord(
                                              queryBuilder: (brandsRecord) => brandsRecord.where(
                                                'name',
                                            ...
                                            builder: (context, snapshot) {
                                              ...
                                              List<BrandsRecord> ratingBarBrandsRecordList = snapshot.data!;
                                              // Return an empty Container when the item does not exist.
                                              if (snapshot.data!.isEmpty) {
                                                return Container();
                                              }
                                              final ratingBarBrandsRecord =
                                                  ratingBarBrandsRecordList.isNotEmpty ? ratingBarBrandsRecordList.first : null;
                                              ...
                                              return RatingBarIndicator(
                                                ...
                                                rating: ratingBarBrandsRecord!.rating,
                                                unratedColor: const Color(0x3457636C),
                                                itemCount: 5,
                                                itemSize: 24.0,
                                              );
                                            },
                                  ...
                                  child: Padding(
                                    ...
                                    child: Text(
                                      ...
                                      style: FlutterFlowTheme.of(context).bodyMedium.override(
                                            ...
                                            useGoogleFonts: GoogleFonts.asMap().containsKey('Mukta'),
                                          ),
                                    ),
                                  ),
                                ),
                        ...
                        child: Padding(
                          ...
                          child: StreamBuilder<List<Orders2Record>>(
                            stream: queryOrders2Record(
                              queryBuilder: (orders2Record) => orders2Record.where(
                                'userRef',
                            ...
                            builder: (context, snapshot) {
                              ...
                              List<Orders2Record> containerOrders2RecordList = snapshot.data!;
                              ...
                              return Container(
                                ...
                                child: Visibility(
                                  visible: functions.ratin(containerOrders2RecordList.toList(), widget.itemRef) ?? true,
                                  child: Align(
                                    alignment: const AlignmentDirectional(0.0, 0.0),
                                    child: Padding(
                                      padding: const EdgeInsetsDirectional.fromSTEB(0.0, 10.0, 0.0, 0.0),
                                      child: StreamBuilder<List<BrandsRecord>>(
                                        ...
                                        builder: (context, snapshot) {
                                          ...
                                          final rowBrandsRecord = rowBrandsRecordList.isNotEmpty ? rowBrandsRecordList.first : null;
                                          ...
                                          return Row(
                                            ...
                                            children: [
                                              ...
                                              Padding(
                                                ...
                                                child: FFButtonWidget(
                                                  onPressed: () async {
                                                    logFirebaseEvent('PRODUCT_DETAIL_COPY_COPY_COPY_RATE_BTN_O');
                                                    logFirebaseEvent('Button_backend_call');

                                                    await rowBrandsRecord!.reference.update(createBrandsRecordData(
                                                      rating: ((_model.ratingBarValue2!) + rowBrandsRecord.rating) / 2,
                                                    ));
                                                  },
                                                  text: 'RATE',
                                                  options: FFButtonOptions(
                      ...
                      StreamBuilder<List<PromocodesRecord>>(
                        ...
                        builder: (context, snapshot) {
                          ...
                          List<PromocodesRecord> containerPromocodesRecordList = snapshot.data!;
                          // Return an empty Container when the item does not exist.
                          if (snapshot.data!.isEmpty) {
                            return Container();
                          }
                          final containerPromocodesRecord = containerPromocodesRecordList.isNotEmpty ? containerPromocodesRecordList.first : null;

                          return Container(
                            decoration: const BoxDecoration(),
                            child: Visibility(
                              visible: rowItemsRecord.brand == containerPromocodesRecord?.brandname,
                              child: Column(
                                mainAxisSize: MainAxisSize.max,
                                children: [
                                  Align(
                                      ...
                                      child: Padding(
                                        ...
                                        child: StreamBuilder<List<BrandsRecord>>(
                                          ...
                                          builder: (context, snapshot) {
                                            ...
                                            List<BrandsRecord> textBrandsRecordList = snapshot.data!;
                                            // Return an empty Container when the item does not exist.
                                            if (snapshot.data!.isEmpty) {
                                              return Container();
                                            }
                                            final textBrandsRecord = textBrandsRecordList.isNotEmpty ? textBrandsRecordList.first : null;
                                        ...
                                        Expanded(
                                          child: StreamBuilder<List<PromocodesRecord>>(
                                            ...
                                            builder: (context, snapshot) {
                                              ...
                                              List<PromocodesRecord> listViewPromocodesRecordList = snapshot.data!;
                                              ...
                                              return ListView.separated(
                                                ...
                                                itemBuilder: (context, listViewIndex) {
                                                  final listViewPromocodesRecord = listViewPromocodesRecordList[listViewIndex];
                                                  return Visibility(
                                                    visible: listViewPromocodesRecord.brandname == rowItemsRecord.brand,
                                                    child: Container(
                                                      width: 380.0,
                                                      decoration: BoxDecoration(
                                                        borderRadius: BorderRadius.circular(0.0),
                                                                        ...
                                                                        showDialog(
                                                                          ...
                                                                          builder: (BuildContext context) {
                                                                            return AlertDialog(
                                                                              ...
                                                                              content: const Text('The offer name has been copied to your clipboard.'),
                                                                              actions: <Widget>[
                                                                                TextButton(
                                                                                  onPressed: () {
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          InkWell(
                                            ...
                                            highlightColor: Colors.transparent,
                                            onTap: () async {
                                              logFirebaseEvent('PRODUCT_DETAIL_COPY_COPY_COPY_Image_v29f');
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          InkWell(
                                            ...
                                            highlightColor: Colors.transparent,
                                            onTap: () async {
                                              logFirebaseEvent('PRODUCT_DETAIL_COPY_COPY_COPY_Image_unhg');
                                              if (MediaQuery.sizeOf(context).width < 800.0) {
                                                logFirebaseEvent('Image_navigate_to');
                                          ...
                                          Row(
                                            ...
                                            children: [
                                              ...
                                              Padding(
                                                padding: const EdgeInsetsDirectional.fromSTEB(0.0, 5.0, 2.0, 5.0),
                                                child: Text(
                                                  formatNumber(
                                                    rowItemsRecord.price,
                                                    formatType: FormatType.custom,
