            ...
            children: [
                                                ...
                                                Align(
                                                  ...
                                                  child: Padding(
                                                    ...
                                                    child: FFButtonWidget(
                                                      onPressed: () async {
                                                        logFirebaseEvent(
                                                            'LOGIN_COMP_GET_STARTED_BTN_ON_TAP');
                                                        logFirebaseEvent(
                                                            'Button_auth');
                                                        GoRouter.of(context)
                                                            .prepareAuthEvent();
                                                ...
                                                Align(
                                                  ...
                                                  child: Padding(
                                                    ...
                                                    child: FFButtonWidget(
                                                      onPressed: () async {
                                                        logFirebaseEvent(
                                                            'LOGIN_COMP_FORGOT_PASSWORD_BTN_ON_TAP');
                                                        logFirebaseEvent(
                                                            'Button_auth');
                                                        GoRouter.of(context)
                                                            .prepareAuthEvent();
              ...
              Align(
                ...
                child: Padding(
                  ...
                  child: InkWell(
                    ...
                    onTap: () async {
                      logFirebaseEvent('LOGIN_COMP_Icon_ncqj05t5_ON_TAP');
              ...
              Align(
                ...
                child: ClipRRect(
                  ...
                  child: Image.asset(
                    'assets/images/Untitled_design_(42).png',
                    height: 50.0,
                    fit: BoxFit.contain,
                  ),
                ),
