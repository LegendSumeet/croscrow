    ...
    return GestureDetector(
      ...
      child: Scaffold(
        ...
        body: MasonryGridView.builder(
          ...
          mainAxisSpacing: 5.0,
          itemCount: context.watch<FFAppState>().gav.toList().length,
          itemBuilder: (context, faverIndex) {
            final faver = context.watch<FFAppState>().gav.toList();
                          ...
                          child: Container(
                            ...
                            child: Padding(
                              ...
                              child: Row(
                                ...
                                children: [
                                  if (containerItemsRecord.discount != 0)
                                    Text(
                                      formatNumber(
