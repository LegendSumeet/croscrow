...
import 'brandpage_model.dart';
export 'brandpage_model.dart';

class BrandpageWidget extends StatefulWidget {
  const BrandpageWidget({
    super.key,
    required this.brand,
  });
  ...
  @override
  State<BrandpageWidget> createState() => _BrandpageWidgetState();
}

class _BrandpageWidgetState extends State<BrandpageWidget> {
  late BrandpageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => BrandpageModel());

    logFirebaseEvent('screen_view', parameters: {'screen_name': 'brandpage'});
    // On page load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      logFirebaseEvent('BRANDPAGE_PAGE_brandpage_ON_INIT_STATE');
      logFirebaseEvent('brandpage_update_page_state');
      _model.brandFilter = widget.brand;
      safeSetState(() {});
    });
        ...
        appBar: AppBar(
            ...
            child: Container(
              ...
              child: Padding(
                ...
                child: InkWell(
                  ...
                  onTap: () async {
                    logFirebaseEvent('BRANDPAGE_PAGE_Icon_bg2mrpyk_ON_TAP');
          ...
          title: Align(
            ...
            child: InkWell(
              ...
              highlightColor: Colors.transparent,
              onTap: () async {
                logFirebaseEvent('BRANDPAGE_PAGE_Image_mx2iw5ek_ON_TAP');
              ...
              child: Container(
                ...
                child: Align(
                  ...
                  child: InkWell(
                    ...
                    highlightColor: Colors.transparent,
                    onTap: () async {
                      logFirebaseEvent('BRANDPAGE_PAGE_Icon_8xa9ii6n_ON_TAP');
                              ...
                              children: [
                                Flexible(
                                  child: InkWell(
                                    ...
                                    onTap: () async {
                                      logFirebaseEvent(
                                          'BRANDPAGE_PAGE_Image_x2kxw0kt_ON_TAP');
                                                  ...
                                                  Builder(
                                                    builder: (context) =>
                                                      ...
                                                      child: InkWell(
                                                        ...
                                                        onTap: () async {
                                                          logFirebaseEvent(
                                                              'BRANDPAGE_PAGE_Icon_zmzig66l_ON_TAP');
                                                          logFirebaseEvent(
                                                              'Icon_alert_dialog');
