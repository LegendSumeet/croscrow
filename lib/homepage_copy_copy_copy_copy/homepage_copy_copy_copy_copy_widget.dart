...
class HomepageCopyCopyCopyCopyWidget extends StatefulWidget {
  ...
  @override
  State<HomepageCopyCopyCopyCopyWidget> createState() =>
      _HomepageCopyCopyCopyCopyWidgetState();
}
...
class _HomepageCopyCopyCopyCopyWidgetState
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'homepageCopyCopyCopyCopy'});
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      logFirebaseEvent('HOMECOPY_COPY_COPY_COPY_homepageCopyCopy');
      if (loggedIn != true) {
        logFirebaseEvent('homepageCopyCopyCopyCopy_alert_dialog');
        await showDialog(
          context: context,
                      ...
                      children: [
                        Padding(
                          ...
                          child: InkWell(
                            ...
                            onTap: () async {
                              logFirebaseEvent(
                                  'HOMECOPY_COPY_COPY_COPY_Icon_uc94rvjl_ON');
                          ...
                          child: Column(
                            ...
                            children: [
                                    ...
                                    Container(
                                      ...
                                      child: FlutterFlowDropDown<String>(
                                        ...
                                        onChanged: (val) async {
                                          ...
                                          logFirebaseEvent(
                                              'HOMECOPY_COPY_COPY_COPY_DropDown_qsidntb');
                                          logFirebaseEvent(
                                    ...
                                    Container(
                                      ...
                                      child: FlutterFlowDropDown<String>(
                                        ...
                                        onChanged: (val) async {
                                          ...
                                          logFirebaseEvent(
                                              'HOMECOPY_COPY_COPY_COPY_DropDown_rxk1gxk');
                                          logFirebaseEvent(
                                              'DropDown_navigate_to');
                              ...
                              InkWell(
                                ...
                                onTap: () async {
                                  logFirebaseEvent(
                                      'HOMECOPY_COPY_COPY_COPY_changePassword_O');
                                  logFirebaseEvent(
                              ...
                              InkWell(
                                ...
                                onTap: () async {
                                  logFirebaseEvent(
                                      'HOMECOPY_COPY_COPY_COPY_editProfile_ON_T');
                              ...
                              Builder(
                                builder: (context) => InkWell(
                                  ...
                                  onTap: () async {
                                    logFirebaseEvent(
                                        'HOMECOPY_COPY_COPY_COPY_submitFeature_ON');
                                    if (loggedIn == true) {
                                      logFirebaseEvent(
                                ...
                                child: Container(
                                  ...
                                  child: Padding(
                                    ...
                                    child: InkWell(
                                      ...
                                      onTap: () async {
                                        logFirebaseEvent(
                                            'HOMECOPY_COPY_COPY_COPY_Column_fz56pj6r_');
                              ...
                              Container(
                                ...
                                child: Padding(
                                  ...
                                  child: InkWell(
                                    ...
                                    onTap: () async {
                                      logFirebaseEvent(
                                          'HOMECOPY_COPY_COPY_COPY_Column_gr6w9jge_');
                                      logFirebaseEvent('Column_navigate_to');
                                        ...
                                        Row(
                                          ...
                                          children: [
                                            InkWell(
                                              ...
                                              onTap: () async {
                                                logFirebaseEvent(
                                                    'HOMECOPY_COPY_COPY_COPY_Text_hvb5pmdy_ON');
                                                logFirebaseEvent(
                                                    'Text_navigate_to');
                              ...
                              Container(
                                ...
                                child: Padding(
                                  ...
                                  child: InkWell(
                                    ...
                                    onTap: () async {
                                      logFirebaseEvent(
                                          'HOMECOPY_COPY_COPY_COPY_Column_nrj0hpi7_');
                                      logFirebaseEvent('Column_navigate_to');
                              ...
                              Container(
                                ...
                                child: Padding(
                                  ...
                                  child: InkWell(
                                    ...
                                    onTap: () async {
                                      logFirebaseEvent(
                                          'HOMECOPY_COPY_COPY_COPY_Column_8nqhaeu4_');
                                      logFirebaseEvent('Column_navigate_to');
                              ...
                              Container(
                                ...
                                child: Padding(
                                  ...
                                  child: InkWell(
                                    ...
                                    onTap: () async {
                                      logFirebaseEvent(
                                          'HOMECOPY_COPY_COPY_COPY_Column_wcdyp9c1_');
                                      logFirebaseEvent('Column_navigate_to');
                              ...
                              Container(
                                ...
                                child: Padding(
                                  ...
                                  child: InkWell(
                                    ...
                                    onTap: () async {
                                      logFirebaseEvent(
                                          'HOMECOPY_COPY_COPY_COPY_Column_4om49zn2_');
                                      logFirebaseEvent('Column_navigate_to');

                                      context.pushNamed(
                                          'returnpolicycancellation');
                                    },
                                    child: Column(
                                      mainAxisSize: MainAxisSize.max,
                                      mainAxisAlignment:
              ...
              child: Container(
                ...
                child: Padding(
                  ...
                  child: InkWell(
                    ...
                    onTap: () async {
                      logFirebaseEvent(
                          'HOMECOPY_COPY_COPY_COPY_Icon_6j8jshky_ON');
                ...
                child: Container(
                  ...
                  child: Align(
                    ...
                    child: InkWell(
                      ...
                      onTap: () async {
                        logFirebaseEvent(
                            'HOMECOPY_COPY_COPY_COPY_Icon_m7qdtm3m_ON');
              ...
              child: Column(
                ...
                children: [
                      ...
                      child: Row(
                        ...
                        children: [
                          buildCategoryItem(
                            ...
                            onTap: () {
                              logFirebaseEvent(
                                  'HOMECOPY_COPY_COPY_COPY_Column_a6n070no_');
                              logFirebaseEvent('Column_navigate_to');
                              context.pushNamed('brands');
                            },
                          ),
                          ...
                          buildCategoryItem(
                            ...
                            onTap: () {
                              logFirebaseEvent(
                                  'HOMECOPY_COPY_COPY_COPY_Column_yw779kdh_');
                              logFirebaseEvent('Column_navigate_to');
                              context.pushNamed(
                                'catpage',
                                queryParameters: {
                          ...
                          buildCategoryItem(
                            ...
                            onTap: () {
                              logFirebaseEvent(
                                  'HOMECOPY_COPY_COPY_COPY_Column_gqbc6o57_');
                              logFirebaseEvent('Column_navigate_to');
                              context.pushNamed(
                                'catpage',
                                queryParameters: {
                          ...
                          buildCategoryItem(
                            ...
                            onTap: () {
                              logFirebaseEvent(
                                  'HOMECOPY_COPY_COPY_COPY_Column_hoyb6jw8_');
                              logFirebaseEvent('Column_navigate_to');
                              context.pushNamed(
                                'catpage',
                                queryParameters: {
                    ...
                    child: StreamBuilder<List<ItemsRecord>>(
                      ...
                      builder: (context, snapshot) {
                        ...
                        return SingleChildScrollView(
                          ...
                          child: Row(
                            mainAxisSize: MainAxisSize.max,
                            children: List.generate(rowItemsRecordList.length,
                                (rowIndex) {
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    InkWell(
                                      ...
                                      onTap: () async {
                                        logFirebaseEvent('Image_navigate_to');
                                        String routeName = (screenWidth < 800.0)
                                            ? 'ProductDetail'
                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: InkWell(
                            ...
                            onTap: () async {
                              logFirebaseEvent(
                                  'HOMECOPY_COPY_COPY_COPY_Text_v5xi8aqc_ON');
                    ...
                    child: StreamBuilder<List<ItemstyleRecord>>(
                      stream: queryItemstyleRecord(
                        queryBuilder: (itemstyleRecord) =>
                            itemstyleRecord.orderBy('uniquestyle'),
                      ),
                      builder: (context, snapshot) {
                            ...
                            children: List.generate(
                              ...
                              (rowIndex) {
                                final rowItemstyleRecord =
                                    rowItemstyleRecordList[rowIndex];
                                return Padding(
                                  padding:
                                  ...
                                  child: InkWell(
                                    ...
                                    onTap: () async {
                                      logFirebaseEvent(
                                          'HOMECOPY_COPY_COPY_COPY_Image_b64gp24b_O');
                                      logFirebaseEvent('Image_navigate_to');
                          ...
                          child: Align(
                            ...
                            child: Padding(
                              ...
                              child: InkWell(
                                ...
                                onTap: () async {
                                  logFirebaseEvent(
                                      'HOMECOPY_COPY_COPY_COPY_Text_gykiyhx6_ON');
                                  logFirebaseEvent('Text_navigate_to');
                  ...
                  Container(
                    width: double.infinity,
                    height:
                        MediaQuery.sizeOf(context).width > 1200.0 ? 1550 : 1320,
                    decoration: BoxDecoration(
                    ...
                    child: StreamBuilder<List<ItemsRecord>>(
                      ...
                      builder: (context, snapshot) {
                        ...
                        // Calculate grid properties once
                        double screenWidth = MediaQuery.sizeOf(context).width;
                        bool isLargeScreen = screenWidth > 1200.0;
                        bool isSmallScreen = screenWidth < 1000.0;
                            ...
                            return Card.filled(
                              ...
                              child: Container(
                                height: isSmallScreen
                                    ? 320.0
                                    : 500.0, // Directly apply the height condition
                                decoration: BoxDecoration(
                                  color: FlutterFlowTheme.of(context)
                                      .secondaryBackground,
                                                      ...
                                                      Builder(
                                                        builder: (context) =>
                                                          ...
                                                          child: InkWell(
                                                            ...
                                                            onTap: () async {
                                                              logFirebaseEvent(
                                                                  'HOMECOPY_COPY_COPY_COPY_Icon_1yi5re7q_ON');
                                                              logFirebaseEvent(
                                                                  'Icon_alert_dialog');
                  ...
                  Padding(
                    ...
                    child: Container(
                      ...
                      child: FFButtonWidget(
                        onPressed: () async {
                          logFirebaseEvent(
                              'HOMECOPY_COPY_COPY_COPY_VIEW_ALL_BTN_ON_');
...
class OptimizedCarousel extends StatelessWidget {
  final CarouselSliderController _carouselController1 =
      CarouselSliderController();
  final CarouselSliderController _carouselController2 =
      CarouselSliderController();
