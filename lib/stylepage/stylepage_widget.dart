...
import 'stylepage_model.dart';
export 'stylepage_model.dart';

class StylepageWidget extends StatefulWidget {
  const StylepageWidget({
    super.key,
  ...
  @override
  State<StylepageWidget> createState() => _StylepageWidgetState();
}

class _StylepageWidgetState extends State<StylepageWidget> {
  late StylepageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => StylepageModel());

    logFirebaseEvent('screen_view', parameters: {'screen_name': 'stylepage'});
        ...
        appBar: AppBar(
            ...
            child: Container(
              ...
              child: Padding(
                ...
                child: InkWell(
                  ...
                  onTap: () async {
                    logFirebaseEvent('STYLEPAGE_PAGE_Icon_y2uap2zz_ON_TAP');
          ...
          title: Align(
            ...
            child: InkWell(
              ...
              highlightColor: Colors.transparent,
              onTap: () async {
                logFirebaseEvent('STYLEPAGE_PAGE_Image_a76xeu1b_ON_TAP');
              ...
              child: Container(
                ...
                child: Align(
                  ...
                  child: InkWell(
                    ...
                    highlightColor: Colors.transparent,
                    onTap: () async {
                      logFirebaseEvent('STYLEPAGE_PAGE_Icon_0a0dx4zs_ON_TAP');
                              ...
                              children: [
                                Flexible(
                                  child: InkWell(
                                    ...
                                    onTap: () async {
                                      logFirebaseEvent(
                                          'STYLEPAGE_PAGE_Image_20q06q4e_ON_TAP');
                                                  ...
                                                  Builder(
                                                    builder: (context) =>
                                                      ...
                                                      child: InkWell(
                                                        ...
                                                        onTap: () async {
                                                          logFirebaseEvent(
                                                              'STYLEPAGE_PAGE_Icon_1p05my42_ON_TAP');
                                                          logFirebaseEvent(
                                                              'Icon_alert_dialog');
