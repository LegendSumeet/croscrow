...
class _OrderspageWidgetState extends State<OrderspageWidget> {
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view', parameters: {'screen_name': 'orderspage'});
        ...
        appBar: AppBar(
            ...
            child: Container(
              ...
              child: Padding(
                ...
                child: InkWell(
                  ...
                  onTap: () async {
                    logFirebaseEvent('ORDERSPAGE_PAGE_Icon_ngf5zrq5_ON_TAP');
          ...
          title: Align(
            ...
            child: InkWell(
              ...
              highlightColor: Colors.transparent,
              onTap: () async {
                logFirebaseEvent('ORDERSPAGE_PAGE_Image_udv0llur_ON_TAP');
              ...
              child: Container(
                ...
                child: Align(
                  ...
                  child: InkWell(
                    ...
                    highlightColor: Colors.transparent,
                    onTap: () async {
                      logFirebaseEvent('ORDERSPAGE_PAGE_Icon_njvnmbhl_ON_TAP');
                ...
                Container(
                  ...
                  child: StreamBuilder<List<Orders2Record>>(
                    stream: queryOrders2Record(
                      queryBuilder: (orders2Record) => orders2Record
                          .where(
                            'userRef',
                    ...
                    builder: (context, snapshot) {
                      ...
                      List<Orders2Record> listViewOrders2RecordList =
                          snapshot.data!;
                      ...
                      return ListView.builder(
                        ...
                        itemCount: listViewOrders2RecordList.length,
                        itemBuilder: (context, listViewIndex) {
                          final listViewOrders2Record =
                              listViewOrders2RecordList[listViewIndex];
                          return Padding(
                              ...
                              child: Column(
                                ...
                                children: [
                                  Padding(
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        ...
                                        if (listViewOrders2Record.status ==
                                            'SHIPPED')
                                          Column(
                                            mainAxisSize: MainAxisSize.max,
                                            children: [
                                              ...
                                              Row(
                                                ...
                                                children: [
                                                  ...
                                                  InkWell(
                                                    ...
                                                    onTap: () async {
                                                      logFirebaseEvent(
                                                          'ORDERSPAGE_PAGE_Icon_qxb7naf8_ON_TAP');
                                                      logFirebaseEvent(
                                                          'Icon_copy_to_clipboard');
                                                      await Clipboard.setData(
                                                          ClipboardData(
                                                              text: listViewOrders2Record
                                                                  .trackingid));
                                                    },
                                                    child: Icon(
                                                      Icons.content_copy,
                                  ...
                                  Container(
                                    ...
                                    child: Builder(
                                      builder: (context) {
                                        final orderlist = listViewOrders2Record
                                            .ordereditems
                                            .toList();
                                                                    ...
                                                                    child: StreamBuilder<
                                                                      ...
                                                                      builder:
                                                                        ...
                                                                        return InkWell(
                                                                          ...
                                                                          onTap:
                                                                              () async {
                                                                            logFirebaseEvent('ORDERSContainer_723ajsyg_ON_TAP');
                                                                            ...
                                                                            context.pushNamed(
                                                                              ...
                                                                              queryParameters: {
                                                                                'itemref': serializeParam(
                                                                                  containerItemsRecord.reference,
                                                                                  ParamType.DocumentReference,
                                                                                ),
                                                                                'orderid': serializeParam(
                                                                                  listViewOrders2Record.orderid.toString(),
                                                                                  ParamType.String,
                                                                                ),
                                                                              }.withoutNulls,
                                                                            );
